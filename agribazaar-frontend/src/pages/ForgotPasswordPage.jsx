    ...
    <>
      ...
      <div style={containerStyle}>
        <div style={cardStyle}>
          ...
          <p style={subtitleStyle}>Enter your email address and we'll send you a link to reset your password.</p>
          ...
          <div style={linkStyle}>
            ...
            <span style={linkAnchorStyle} onClick={() => handleNavigate("/login")}> Login</span>
          </div>

          <div style={linkStyle}>
            Don't have an account?
            <span style={linkAnchorStyle} onClick={() => handleNavigate("/register")}> Register</span>
          </div>
        </div>
      </div>
    </>

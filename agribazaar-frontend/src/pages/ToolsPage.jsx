...
const ToolsPage = () => {
  ...
  useEffect(() => {
    setLoading(true);
    setError(null);
    AuthService.fetchAdminProducts("Tools")
      .then(res => {
        setProducts(res || []);
        setLoading(false);
      })
    ...
    <div style={{ minHeight: "100vh", background: "#f5f5f5", display: "flex", flexDirection: "column" }}>
      ...
      <main style={{ flex: 1, padding: "clamp(1rem, 3vw, 2rem)", maxWidth: "1400px", margin: "0 auto", width: "100%" }}>
        ...
        {loading ? (
          <div style={{
            ...
            <p style={{ color: "#666", fontSize: "0.95rem" }}>Loading tools...</p>
          </div>
        ) : products.length === 0 ? (
          <div style={{
            textAlign: "center",
              ...
              >
                ...
                <div style={{
                  ...
                  <button
                    ...
                    onMouseEnter={(e) => {
                      e.target.style.background = "#ca6702";
                      e.target.style.borderColor = "#ca6702";
                    }}
                    onMouseLeave={(e) => {
      ...
      <style>{`
        ...
        @media (min-width: 481px) and (max-width: 768px) {
          div { --grid-cols: repeat(auto-fill, minmax(160px, 1fr)); }
        }
